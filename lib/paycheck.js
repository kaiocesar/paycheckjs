...
class Paycheck {
    ...
    calcular_salario_liquido(salario_base, dependentes) {
        const inss = this.calcular_inss(salario_base)
        const irrf = this.calcular_irrf(salario_base, dependentes)
        const salario_liquido = salario_base - irrf - inss;
